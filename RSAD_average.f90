program average_data
    ...
    integer, parameter :: max_rows = 100  ! Adjust based on expected data size
    integer :: i, j, count
    ...
    do i = 1, n
        write(filename, '(A,I0,A)') "c", i, ".txt"  ! Generate filename like c1.txt, c2.txt
...
100     close(10)
    ...
    open(20, file="avg_data.txt", status="replace", action="write")
    do j = 1, count
